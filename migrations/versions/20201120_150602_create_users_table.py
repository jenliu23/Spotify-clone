...
def upgrade():
    ...
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('artist', sa.String(), nullable=False),
    sa.Column('releasedYear', sa.Integer(), nullable=False),
    sa.Column('coverImage', sa.String(), nullable=False),
    sa.Column('createdAt', sa.DateTime(), nullable=False),
    sa.Column('updatedAt', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['userId'], ['users.id'], ),
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE favorite_songs SET SCHEMA {SCHEMA};")

    op.create_table('favorite_playlists',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('userId', sa.Integer(), nullable=False),
    sa.Column('playlistId', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['userId'], ['users.id']),
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE favorite_playlists SET SCHEMA {SCHEMA};")
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE favorite_albums SET SCHEMA {SCHEMA};")

def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('favorite_albums')
    op.drop_table('favorite_playlists')
